            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?php echo $form->dropDownList($model, 'tagSelected', $model->getListCategory(), array('class' => 'form-control', 'multiple' => 'multiple', 'style' => 'height: auto;')); ?>
                        <?php echo $form->error($model, 'tagSelected'); ?>
                    </div>
                    <div class="col-md-6">
